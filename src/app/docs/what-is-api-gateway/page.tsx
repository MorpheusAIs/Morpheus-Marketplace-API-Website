        ...
        <div className="bg-[var(--eclipse)] p-6 rounded-lg shadow-md border-2 border-[var(--emerald)]/30">
          ...
          <div className="bg-[var(--matrix-green)] border-l-4 border-[var(--neon-mint)] p-4 space-y-2">
            <p className="text-[var(--platinum)] font-medium">
              <strong>API Gateway Base URL:</strong> <code className="bg-[var(--midnight)] px-2 py-1 rounded">https://api.mor.org/api/v1</code>
            </p>
            <p className="text-[var(--platinum)] font-medium">
              <strong>API Gateway Swagger UI:</strong> <a href="https://api.mor.org/docs" className="text-[var(--neon-mint)] hover:text-[var(--emerald)]">https://api.mor.org/docs</a>
            </p>
            <p className="text-[var(--platinum)] font-medium">
