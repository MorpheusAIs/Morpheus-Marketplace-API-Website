            ...
            <div className="rounded-md shadow-sm -space-y-px">
              ...
              <div>
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="appearance-none rounded-none relative block w-full px-3 py-2 border border-[var(--neon-mint)]/30 placeholder-gray-400 text-[var(--midnight)] bg-white focus:outline-none focus:ring-[var(--neon-mint)] focus:border-[var(--neon-mint)] focus:z-10 sm:text-sm"
